...
if [ ! -v KALDI_BIN_PATH ]
then
	export KALDI_BIN_PATH="$KALDI_REP_PATH/src/bin:$KALDI_REP_PATH/src/gmmbin:$KALDI_REP_PATH/src/featbin:$KALDI_REP_PATH/src/fstbin:$KALDI_REP_PATH/tools/openfst/bin"
